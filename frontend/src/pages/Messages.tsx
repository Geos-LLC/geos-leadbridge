...
export function Messages() {
  ...
  const AI_STRATEGIES = [
    { key: 'hybrid', label: 'Hybrid', emoji: '⚖️', prompt: 'STRATEGY: HYBRID — You MUST do BOTH of these in your reply:\n1. Give a price range (even rough) based on what you know\n2. Ask exactly ONE clarifying question to narrow the quote\nYour reply must contain a dollar amount or range AND a question mark. Balance helpfulness with information gathering.' },
    { key: 'price', label: 'Price', emoji: '💰', prompt: 'STRATEGY: PRICE ANCHOR — Your reply MUST lead with pricing.\n1. Open with a specific price range or quote based on available details\n2. Briefly explain what\'s included at that price\n3. Do NOT ask questions — give the customer a number to react to\nYour reply must contain a dollar amount. Be confident and direct about cost.' },
    { key: 'qualify', label: 'Qualify', emoji: '🧠', prompt: 'STRATEGY: QUALIFICATION — Your reply must be questions-focused.\n1. Do NOT give any pricing or cost estimates\n2. Ask 2-3 specific questions about their needs (scope, timing, preferences)\n3. Explain briefly WHY you need this info ("so I can give you an accurate quote")\nYour reply must NOT contain any dollar amounts. Focus entirely on understanding their needs.' },
    { key: 'convert', label: 'Convert', emoji: '📞', prompt: 'STRATEGY: CONVERSION — Your reply must push toward a concrete next step.\n1. Propose a specific action: schedule a call, book an appointment, set a date/time\n2. Offer a specific time slot or ask "Would tomorrow at 2pm work?"\n3. Create gentle urgency ("I have availability this week")\n4. Do NOT ask open-ended questions — present a clear next step\nYour reply must include a specific call-to-action with a time or scheduling suggestion.' },
  ];
