...
export function Messages() {
  ...
  const AI_STRATEGIES = [
    ...
    { key: 'convert', label: 'Convert', emoji: '📞', prompt: 'STRATEGY: CONVERSION\n\nUse when:\n- Price has been discussed or customer shows buying signals\n- Customer said "ASAP", "today", "this week", "sounds good", "yes"\n\nYou MUST:\n- Propose a specific next step (date, time, booking link)\n- Create gentle urgency ("I have availability this week")\n- Make it easy to say yes\n\nDO NOT:\n- Ask open-ended questions\n- Re-discuss pricing unless asked\n- Say "let me know" — instead propose something concrete\n\nGoal: Close the booking.\nExample style: "I can have a team there [day]. Would [time] work for you?"' },
  ];
